<?php
 ...
 $varnamabarang=$_REQUEST['caribarang'];
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <ul>
          ...
          <li class="dropdown has-dropdown"><a href="#"><span>Dropdown</span> <i class="bi bi-chevron-down"></i></a>
            <ul class="dd-box-shadow">
              <li><a href="1.php">Example 1</a></li>             
              <li><a href="2.php">Example 2</a></li>
              <li><a href="3.php">Example 3</a></li>
...
<?php
$query = "SELECT * FROM tbl_data_barang WHERE nama_barang LIKE '%$varnamabarang%' ORDER BY nama_barang";
