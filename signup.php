...
<body class="index-page" data-bs-spy="scroll" data-bs-target="#navmenu">
    ...
    <section id="hero" class="hero">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-5">
      <form name=formregister action="nyimpandata.php">
		<input type=text class="form-control" name=userid placeholder='UserID'>
		<BR>
		<input type=text class="form-control" name=usernama placeholder='Username'>
		<BR>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="container copyright text-center mt-4">
      <p>&copy; <span>Copyright</span> <strong class="px-1">Append-Kerin</strong> <span>All Rights Reserved</span></p>
      <div class="credits">
